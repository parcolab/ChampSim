...
private:
  ...
  int check_row_hit_in_rq(int channel, int rank, int bank);
  int check_row_hit_in_wq(int channel, int rank, int bank);
  int is_row_hit_in_rq(int channel);
  int is_row_hit_in_wq(int channel);
